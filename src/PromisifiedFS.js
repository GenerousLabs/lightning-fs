...
const AsyncStorageBackend = require("./AsyncStorageBackend.js");
...
module.exports = class PromisifiedFS {
  ...
  async _init (name, {
    ...
    this._name = name
    this._idb = useAsyncStorage ? new AsyncStorageBackend(fileDbName, fileStoreName) : new IdbBackend(fileDbName, fileStoreName);
